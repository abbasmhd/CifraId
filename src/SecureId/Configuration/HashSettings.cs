namespace SecureId.Configuration;

/// <summary>
/// Configuration options for the SecureId hashing behavior.
...
public sealed class HashSettings
{
    ...
    /// <summary>
    /// Whether SecureId encoding is enabled. In non-development environments this is
    ...
    /// </summary>
    public string Salt { get; set; } = "SecureId-Dev-Salt-CHANGE-IN-PRODUCTION";
