...
/// <summary>
/// Default implementation of <see cref="ISecureIdService"/> that delegates
...
public sealed class SecureIdService : ISecureIdService
{
    ...
    /// <summary>Creates a new <see cref="SecureIdService"/>.</summary>
    public SecureIdService(IEncoder encoder)
    {
