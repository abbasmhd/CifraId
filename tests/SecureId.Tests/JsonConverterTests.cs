...
public class JsonConverterTests
{
    ...
    public JsonConverterTests()
    {
        ...
        var transform = new DefaultSecureIdOutboundStringTransform();
        var factory = new SecureIdJsonConverterFactory(_service, transform);
    ...
    [Fact]
    public void Serialize_Encodes_SecureId_Int_Property()
    {
    ...
    [Fact]
    public void Deserialize_Decodes_SecureId_Int_Property()
    {
